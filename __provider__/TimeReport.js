const { CHECKPOINT_BLOCK } = require("./Constants.js");
...
// Sets fromBlock to the value of an environment variable if one is set.
// This can be set to 0 to make tests work with Ganache, or any other value needed for a production script or bot.
